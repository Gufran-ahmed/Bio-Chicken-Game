...
//most code copied over from worm
//aka the finding goal thing
   ...
   private void loadEdemonFrames()
{
    ...
    eframes[0] = new GreenfootImage("edemonframea.gif");
    eframes[1] = new GreenfootImage("edemonframeb.gif");
    eframes[2] = new GreenfootImage("edemonframec.gif");
    eframes[3] = new GreenfootImage("edemonframed.gif");
    eframes[4] = new GreenfootImage("edemonframef.gif");
    eframes[5] = new GreenfootImage("edemonframeg.gif");
    eframes[6] = new GreenfootImage("edemonframeh.gif");
    
    eframes[0+16] = new GreenfootImage("edemonframea.gif");
    eframes[1+16] = new GreenfootImage("edemonframeb.gif");
    eframes[2+16] = new GreenfootImage("edemonframec.gif");
    eframes[3+16] = new GreenfootImage("edemonframed.gif");
    eframes[4+16] = new GreenfootImage("edemonframef.gif");
    eframes[5+16] = new GreenfootImage("edemonframeg.gif");
    eframes[6+16] = new GreenfootImage("edemonframeh.gif");
